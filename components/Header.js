...
const items = [
    { icon: 'fab fa-youtube', link: 'https://youtube.com/@n0kii' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/994159473558040587' },
    { icon: 'fab fa-twitter', link: 'https://twitter.com/nn0ki' },
    { icon: 'fab fa-github', link: 'https://github.com/nn0ki' },
  ]
    ...
    return <>
        <div className="w-full border-b-2 border-neutral-800/20 pb-2">
            <div className="flex flex-col md:flex-row w-full items-center md:justify-between">
                <p className="font-semibold font-Poppins text-xl">n0ki</p>
